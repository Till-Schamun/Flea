...
data_Straight_flights <- read_sheet("1_khKqNaFJBH0Awyg4olOCRySjCSQpk8JBAA3b83wKBA", sheet = "Straight_flights")data_flightcage <- read_sheet("1_khKqNaFJBH0Awyg4olOCRySjCSQpk8JBAA3b83wKBA", sheet = "FlightCage")

#file calculation
directory <- "D:/Flanders25/Videos/20250521/data"
infile <- file.path(directory, "FinalOut3DDict2_20250521_C0005_aligned.csv")
df <- fread(infile)
